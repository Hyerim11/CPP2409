...
bool moveUser(vector<vector<int>> map, int& user_x, int& user_y, User& user, string user_input);
...
int main() {
    ...
    while (1) {  // 사용자에게 계속 입력받기 위해 무한 루프
        ...
        // 사용자의 입력을 저장할 변수
        string user_input = "";
        cout << "현재 HP: " << user1.GetHP() << " 명령어를 입력하세요 (up,down,left,right,map,info,quit): ";
        cin >> user_input;
